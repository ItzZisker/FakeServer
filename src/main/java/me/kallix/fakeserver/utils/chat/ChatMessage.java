...
import me.kallix.fakeserver.exceptions.ChatMessageException;
import me.kallix.fakeserver.utils.locale.LocaleI18n;
...
public class ChatMessage extends ChatBaseComponent {
        ...
        try {
            ...
            for(; var3.find(var5); var5 = var7) {
                ...
                if ("%".equals(var14) && "%%".equals(var9)) {
                    ...
                    if (!"s".equals(var14)) {
                        throw new ChatMessageException(this, "Unsupported format: '" + var9 + "'");
                    }
    ...
    private IChatBaseComponent a(int var1) {
        if (var1 >= this.e.length) {
            throw new ChatMessageException(this, var1);
        } else {
    ...
    public ChatMessage h() {
        ...
        var5.setChatModifier(this.getChatModifier().clone());
